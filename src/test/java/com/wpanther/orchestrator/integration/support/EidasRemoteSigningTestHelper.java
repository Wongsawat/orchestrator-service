package com.wpanther.orchestrator.integration.support;
...
/**
 * Bootstraps eidasremotesigning for cross-service integration tests.
 *
 ...
 * </pre>
 *
 * <p>Both authentication key (credential ID) and PIN (keystore password) are
 * required for the BCFKS keystore. The PIN is hardcoded ({@code eidas-signing-2024})
 * matching the keystore created by {@code scripts/create-eidas-keystore.sh}.
 * The authentication key is the UUID of the inserted {@code signing_certificates} row.
 */
public final class EidasRemoteSigningTestHelper {
    ...
    private static ClientCredentials registerClient(String eidasBaseUrl) throws Exception {
        String body = MAPPER.writeValueAsString(java.util.Map.of(
                "clientName", "orchestrator-cross-service-test",
        ...
        String sql = """
                ...
                VALUES
                    (?, 'BCFKS', ?, ?, ?, ?, true, CURRENT_TIMESTAMP,
                     'Integration test credential — inserted by EidasRemoteSigningTestHelper (orchestrator cross-service)')
                """;
