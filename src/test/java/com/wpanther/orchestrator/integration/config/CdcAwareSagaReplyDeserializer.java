 ...
 * </pre>
 *
 * <p>Only active in the {@code cross-service-test} profile via
 * {@link CrossServiceTestConfiguration}.
 */
public class CdcAwareSagaReplyDeserializer implements Deserializer<SagaReply> {
    ...
    public CdcAwareSagaReplyDeserializer(ObjectMapper replyMapper) {
        this.objectMapper = replyMapper;
    }
