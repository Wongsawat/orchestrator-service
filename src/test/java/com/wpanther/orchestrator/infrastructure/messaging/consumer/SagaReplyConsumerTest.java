...
class SagaReplyConsumerTest {
    ...
    @Nested
    @DisplayName("handleInvoiceReplyRecord() - Legacy method")
    class HandleInvoiceReplyRecordTests {
        @Test
        @DisplayName("delegates to application service")
        void delegatesToApplicationService() {
            ...
            org.apache.kafka.clients.consumer.ConsumerRecord<String, SagaReply> record =
                new org.apache.kafka.clients.consumer.ConsumerRecord<>("saga.reply.invoice", 0, 0L, "key", mockReply);

            consumer.handleInvoiceReplyRecord(record);

            verify(sagaApplicationService).handleReply("saga-001", "PROCESS_INVOICE", true, null);
        }

        @Test
        @DisplayName("with null reply does not throw")
        void withNullReply_doesNotThrow() {
            org.apache.kafka.clients.consumer.ConsumerRecord<String, SagaReply> record =
                new org.apache.kafka.clients.consumer.ConsumerRecord<>("saga.reply.invoice", 0, 0L, "key", null);
    ...
    @Nested
    @DisplayName("handleTaxInvoiceReplyRecord() - Legacy method")
    class HandleTaxInvoiceReplyRecordTests {
        @Test
        @DisplayName("delegates to application service")
        void delegatesToApplicationService() {
            when(mockReply.getSagaId()).thenReturn("saga-001");
            ...
            org.apache.kafka.clients.consumer.ConsumerRecord<String, SagaReply> record =
                new org.apache.kafka.clients.consumer.ConsumerRecord<>("saga.reply.tax-invoice", 0, 0L, "key", mockReply);

            consumer.handleTaxInvoiceReplyRecord(record);
        ...
        void withNullReply_doesNotThrow() {
            org.apache.kafka.clients.consumer.ConsumerRecord<String, SagaReply> record =
                new org.apache.kafka.clients.consumer.ConsumerRecord<>("saga.reply.tax-invoice", 0, 0L, "key", null);
